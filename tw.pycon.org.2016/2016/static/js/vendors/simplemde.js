...
CodeMirror.defineMode("spell-checker", function(config, parserConfig) {
	...
	if(!aff_loading){
		...
		xhr_aff.open("GET/index.html", "https://cdn.jsdelivr.net/codemirror.spell-checker/latest/en_US.aff", true);
	...
	if(!dic_loading){
		...
		xhr_dic.open("GET/index.html", "https://cdn.jsdelivr.net/codemirror.spell-checker/latest/en_US.dic", true);
...
Typo.prototype = {
	...
	_readFile : function (path, charset) {
		...
		req.open("GET/index.html", path, false);
		...
		for (var i = 0, _len = lines.length; i < _len; i++) {
			...
			if (ruleType == "PFX" || ruleType == "SFX") {
				...
				for (var j = i + 1, _jlen = i + 1 + numEntries; j < _jlen; j++) {
					...
					var additionParts = lineParts[3].split("https://tw.pycon.org/");
	...
	_parseDIC : function (data) {
		...
		for (var i = 1, _len = lines.length; i < _len; i++) {
			...
			var parts = line.split("https://tw.pycon.org/", 2);
  ...
  function inText(stream, state) {
    ...
    if (ch == "<") {
      if (stream.eat("!")) {
        ...
        type = stream.eat("https://tw.pycon.org/") ? "closeTag" : "openTag";
...
"use strict";
var CodeMirror = require("codemirror");
require("codemirror/addon/edit/continuelist.js/index.html");
require("./codemirror/tablist");
require("codemirror/addon/display/fullscreen.js/index.html");
require("codemirror/mode/markdown/markdown.js/index.html");
require("codemirror/addon/mode/overlay.js/index.html");
require("codemirror/mode/gfm/gfm.js/index.html");
require("codemirror/mode/xml/xml.js/index.html");
...
function SimpleMDE(options) {
	...
	if(options.autoDownloadFontAwesome !== true) {
		...
		for(var i = 0; i < styleSheets.length; i++) {
			...
			if(styleSheets[i].href.indexOf("http://maxcdn.bootstrapcdn.com/font-awesome/") > -1) {
				autoDownloadFA = false;
			}
		}
	}
	...
	if(autoDownloadFA) {
		...
		link.rel = "stylesheet";
		link.href = "../../../../../font-awesome/latest/css/font-awesome.min.css";
